...
export const MOCK_SKILLS: Skill[] = [
  {
    ...
    description: "Subject matter expert in generative AI technologies, including LLMs, diffusion models, and practical applications in enterprise settings.",
  ...
  },
  {
    ...
    rubrics: [
      ...
      },
      {
        stage: "Practitioner",
        estimated_duration: "1-2 years",
        requirements: ["Build scalable applications handling real traffic", "Implement proper testing and CI/CD", "Work effectively in team environments"],
        criteria: [
          {
            criterion_id: "fs-p1",
            name: "Architecture",
  ...
  },
  {
    ...
    rubrics: [
      ...
      },
      {
        stage: "Practitioner",
        estimated_duration: "1-2 years",
        requirements: ["Own at least one product or major feature", "Lead cross-functional teams effectively", "Demonstrate successful product launches"],
        criteria: [
          {
            criterion_id: "pm-p1",
