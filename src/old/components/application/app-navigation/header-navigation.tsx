...
import { BadgeWithDot } from "@/old/components/base/badges/badges";
  ...
  return (
    <>
      ...
      <header className="max-lg:hidden">
        <section
          className={cx("bg-primary md:h-18 flex h-16 w-full items-center justify-center", (!hideBorder || showSecondaryNav) && "border-secondary border-b")}
        >
          <div className="max-w-container flex w-full justify-between pl-4 pr-3 md:px-8">
            <div className="flex flex-1 items-center gap-4">
              <a aria-label="Go to homepage" href="/" className="rounded-xs outline-focus-ring focus-visible:outline-2 focus-visible:outline-offset-2">
                <UntitledLogo className="h-8" />
              </a>
