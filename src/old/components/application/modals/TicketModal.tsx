    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center" aria-modal="true" role="dialog">
      ...
      >
        ...
        <div className="flex min-w-0 flex-1 flex-col overflow-auto p-6">
          ...
          {/* Description */}
          <div className="mb-4">
            <h4 className="text-md mb-2 font-semibold text-gray-600">Description</h4>
          ...
          {/* Subtasks */}
          <div className="mb-4">
            <h4 className="text-md mb-2 font-semibold text-gray-600">Subtasks</h4>
          ...
          {/* Linked Tickets */}
          <div className="mb-4">
            <h4 className="text-md mb-2 font-semibold text-gray-600">Linked tickets</h4>
          ...
          {/* Documents Hierarchy */}
          <div className="mb-4">
            <h4 className="text-md mb-2 font-semibold text-gray-600">Related documents</h4>
            {documentsLoading ? (
              ...
              <div className="space-y-2">
                ...
                {ticketDocuments.project.length > 0 && (
                  <div>
                    ...
                    >
                      {expandedSections.project ? <ChevronDown className="h-3 w-3 text-gray-400" /> : <ChevronRight className="h-3 w-3 text-gray-400" />}
                ...
                {ticketDocuments.epic.length > 0 && (
                  <div>
                    ...
                    >
                      ...
                      {expandedSections.epic ? <ChevronDown className="h-3 w-3 text-gray-400" /> : <ChevronRight className="h-3 w-3 text-gray-400" />}
                ...
                {ticketDocuments.ticket.length > 0 && (
                  <div>
                    ...
                    >
                      ...
                      {expandedSections.ticket ? <ChevronDown className="h-3 w-3 text-gray-400" /> : <ChevronRight className="h-3 w-3 text-gray-400" />}
        ...
        <aside className="flex w-80 flex-shrink-0 flex-col border-l border-gray-100 bg-gray-50 p-4">
                ...
                return (
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <Toggle size="sm" isSelected={currentEvent.completed === true} isDisabled={isCompletionLoading} onChange={handleCompletionToggle} />
                    </div>
                  </div>
                );
              }
          ...
          <div className="mb-4">
            <div className="mb-3 flex items-center justify-between">
              ...
              <button
                ...
                className="flex items-center gap-1.5 rounded-md bg-transparent px-2.5 py-1.5 text-xs font-semibold text-gray-600 hover:cursor-pointer hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-400 disabled:cursor-not-allowed disabled:opacity-50"
              >
            ...
            {notesLoading ? (
              ...
              <div className="space-y-1.5">
                {notes.map((note) => (
                  ...
                  >
                    <svg className="h-3.5 w-3.5 text-gray-400 group-hover:text-blue-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path
                        strokeLinecap="round"
                        strokeLinejoin="round"
                        strokeWidth={1.5}
                    ...
                    <span className="truncate text-xs font-medium text-gray-900 group-hover:text-blue-700">{note.title || "Untitled Note"}</span>
                  </button>
                ))}
              </div>
            ) : (
          ...
          <div className="mt-auto">
            <div className="mb-4 mt-3 text-xs text-gray-500">
