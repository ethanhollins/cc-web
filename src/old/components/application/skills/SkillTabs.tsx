...
export function SkillTabs({ tabs, activeTabId, onTabClick, onTabClose, onNewTab }: SkillTabsProps) {
  return (
    <div className="relative flex items-end border-b border-gray-200 bg-gray-100 px-6">
      {/* Title */}
      <h1 className="mr-4 pb-1 pt-3 text-xl font-bold text-gray-900">Skills Development</h1>
            ...
            return (
              <div
                ...
                className={`group relative flex items-center gap-2 px-4 transition-all ${
                  isActive
                    ? "z-10 -mb-px rounded-t-lg border-x border-t border-gray-200 bg-white pb-2.5 pt-3 shadow-sm"
                    : "cursor-pointer rounded-t-lg bg-gray-200/60 px-4 pb-2 pt-2.5 hover:bg-gray-200"
                }`}
                style={{
                  minWidth: "120px",
                  maxWidth: "200px",
