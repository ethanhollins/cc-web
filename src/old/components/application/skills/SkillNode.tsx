    ...
    <div className="relative flex items-center justify-center">
      ...
      {selected && data.onAddTicket && (
        <button
          ...
          className="absolute -right-2 -top-2 z-10 flex size-10 items-center justify-center rounded-full border-2 border-gray-300 bg-white shadow-md transition-all hover:border-gray-600 hover:bg-gray-50 hover:shadow-lg"
      ...
      >
        ...
        {/* Skill name */}
        <div className="max-w-[90px] text-center text-xs font-semibold leading-tight text-gray-900">{data.name.split(" ").slice(0, 2).join(" ")}</div>
