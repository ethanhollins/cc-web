...
import { SkillStage, SkillStageNode } from "@/old/types/skills";
    ...
    <div className="relative flex items-center justify-center">
      ...
      {selected && data.onAddTicket && (
        <button
          ...
          className="absolute -right-1 -top-1 z-10 flex size-8 items-center justify-center rounded-full border-2 border-gray-300 bg-white shadow-md transition-all hover:border-gray-600 hover:bg-gray-50 hover:shadow-lg"
      ...
      >
        ...
        {isCompleted && (
          <div
            className="absolute -left-1.5 -top-1.5 z-10 flex size-6 items-center justify-center rounded-full bg-white shadow-md"
        ...
        {/* Stage name */}
        <div className="max-w-[70px] text-center text-[10px] font-semibold leading-tight text-gray-900">{data.name}</div>
