    ...
    <div className="relative">
      ...
      {selected && data.onUnlink && (
        <button
          ...
          className="absolute -right-1 -top-1 z-10 flex size-6 items-center justify-center rounded-full border-2 border-red-300 bg-white shadow-md transition-all hover:border-red-600 hover:bg-red-50 hover:shadow-lg"
          title="Unlink ticket"
        >
      ...
      <div
        className={`flex min-w-[160px] max-w-[200px] items-center gap-2 rounded-lg border-2 bg-white px-3 py-2 shadow-sm transition-all ${
