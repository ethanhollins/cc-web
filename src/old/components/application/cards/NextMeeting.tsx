      ...
      <div className="px-5">
        <div className="flex flex-row items-center gap-8">
          <div className="min-w-0 flex-1">
            {/* Title */}
            <h3 className="text-l my-3 font-semibold tracking-tight text-black">{hasNoMeetings ? "No more meetings today" : displayMeeting!.title}</h3>
            ...
            <div className="mb-3 flex flex-col flex-wrap gap-x-6 gap-y-2 text-gray-700">
              ...
              <div className="flex items-center gap-1">
                ...
                <span className="text-md mb-0.5">{locationLabel}</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="min-w-[260px] flex-shrink-0 rounded-2xl bg-gray-100">
          <div className="flex flex-col items-center justify-center gap-4 p-3">
            <div className="flex w-full flex-row items-baseline justify-between">
              <p className="text-md ml-5 flex-1 font-medium text-gray-600">
            ...
            {disableJoin || hasNoMeetings ? (
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="inline-flex w-[100%] items-center justify-center gap-2 rounded-xl bg-black px-3 py-2 text-base font-semibold text-white shadow-sm hover:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-gray-400"
              >
                <VideoRecorder className="size-4" />
                Join Meeting
              </a>
          ...
          {remainingMeetings.length === 0 ? (
            ...
            <ul className="space-y-2">
              {remainingMeetings.map((meeting, idx) => {
                ...
                return (
                  <li key={meeting.ticket_id || idx} className="grid grid-cols-3 items-center gap-2 rounded-lg bg-gray-50 px-2 py-1 text-xs text-gray-600">
