          ...
          {activeEvent ? (
            <>
              ...
              <div className="flex-1">
                ...
                <h3 className="mt-1 font-medium leading-tight">{activeEvent.title}</h3>
            ...
            <>
              ...
              <div className="flex-1">
                ...
                <h3 className="mt-1 font-medium leading-tight">{upcomingEvent.title}</h3>
                <div className="mt-2 flex items-center gap-2">
            ...
            <>
              ...
              <div className="flex-1">
                ...
                <h3 className="mt-1 font-medium leading-tight">You're all done for the day</h3>
