  ...
  return (
    <div className="flex gap-2">
      <div className="flex -space-x-2">
        <Avatar className="ring-bg-primary ring-[1.5px]" size="sm" src="https://www.untitledui.com/images/avatars/olivia-rhye?fm=webp&q=80" alt="Olivia Rhye" />
        <Avatar
        ...
        <Avatar
          ...
          alt="Demi Wilkinson"
        />
        <Avatar className="ring-bg-primary ring-[1.5px]" size="sm" src="https://www.untitledui.com/images/avatars/candice-wu?fm=webp&q=80" alt="Candice Wu" />
        <Avatar
          className="ring-bg-primary ring-[1.5px]"
          size="sm"
          ...
          alt="Natali Craig"
        />
        <Avatar className="ring-bg-primary ring-[1.5px]" size="sm" src="https://www.untitledui.com/images/avatars/drew-cano?fm=webp&q=80" alt="Drew Cano" />
        <Avatar
          className="ring-bg-primary ring-[1.5px]"
          size="sm"
          ...
          alt="Orlando Diggs"
        />
        <Avatar className="ring-bg-primary ring-[1.5px]" size="sm" src="https://www.untitledui.com/images/avatars/andi-lane?fm=webp&q=80" alt="Andi Lane" />
        <Avatar
          className="ring-bg-primary ring-[1.5px]"
          size="sm"
  ...
  <div className="flex flex-col gap-4">
    <div className="flex gap-2">
      <div className="flex -space-x-1">
        <Avatar className="ring-bg-primary ring-[1.5px]" size="xs" src="https://www.untitledui.com/images/avatars/olivia-rhye?fm=webp&q=80" alt="Olivia Rhye" />
        <Avatar
          className="ring-bg-primary ring-[1.5px]"
          size="xs"
          src="https://www.untitledui.com/images/avatars/phoenix-baker?fm=webp&q=80"
        ...
        <Avatar
          ...
          alt="Demi Wilkinson"
        />
        <Avatar className="ring-bg-primary ring-[1.5px]" size="xs" src="https://www.untitledui.com/images/avatars/candice-wu?fm=webp&q=80" alt="Candice Wu" />
        <Avatar
          className="ring-bg-primary ring-[1.5px]"
          size="xs"
          src="https://www.untitledui.com/images/avatars/natali-craig?fm=webp&q=80"
          alt="Natali Craig"
        />
        <Avatar className="ring-bg-primary ring-[1.5px]" size="xs" src="https://www.untitledui.com/images/avatars/drew-cano?fm=webp&q=80" alt="Drew Cano" />
        <Avatar
          className="ring-bg-primary ring-[1.5px]"
          size="xs"
          src="https://www.untitledui.com/images/avatars/orlando-diggs?fm=webp&q=80"
          alt="Orlando Diggs"
        />
        <Avatar className="ring-bg-primary ring-[1.5px]" size="xs" src="https://www.untitledui.com/images/avatars/andi-lane?fm=webp&q=80" alt="Andi Lane" />
        <Avatar
          className="ring-bg-primary ring-[1.5px]"
          size="xs"
          src="https://www.untitledui.com/images/avatars/kate-morrison?fm=webp&q=80"
    ...
    <div className="flex gap-2">
      <div className="flex -space-x-3">
        <Avatar className="ring-bg-primary ring-[1.5px]" size="md" src="https://www.untitledui.com/images/avatars/olivia-rhye?fm=webp&q=80" alt="Olivia Rhye" />
        <Avatar
          className="ring-bg-primary ring-[1.5px]"
          size="md"
          src="https://www.untitledui.com/images/avatars/phoenix-baker?fm=webp&q=80"
        ...
        <Avatar
          ...
          alt="Demi Wilkinson"
        />
        <Avatar className="ring-bg-primary ring-[1.5px]" size="md" src="https://www.untitledui.com/images/avatars/candice-wu?fm=webp&q=80" alt="Candice Wu" />
        <Avatar
          className="ring-bg-primary ring-[1.5px]"
          size="md"
          src="https://www.untitledui.com/images/avatars/natali-craig?fm=webp&q=80"
          alt="Natali Craig"
        />
        <Avatar className="ring-bg-primary ring-[1.5px]" size="md" src="https://www.untitledui.com/images/avatars/drew-cano?fm=webp&q=80" alt="Drew Cano" />
        <Avatar
          className="ring-bg-primary ring-[1.5px]"
          size="md"
          src="https://www.untitledui.com/images/avatars/orlando-diggs?fm=webp&q=80"
          alt="Orlando Diggs"
        />
        <Avatar className="ring-bg-primary ring-[1.5px]" size="md" src="https://www.untitledui.com/images/avatars/andi-lane?fm=webp&q=80" alt="Andi Lane" />
        <Avatar
          className="ring-bg-primary ring-[1.5px]"
          size="md"
          src="https://www.untitledui.com/images/avatars/kate-morrison?fm=webp&q=80"
...
export const Initials = () => (
  <div className="flex flex-col gap-4">
    ...
    <div className="flex items-start gap-8">
      <Avatar size="xs" badge={<AvatarCompanyIcon src="https://www.untitledui.com/logos/images/Layers.jpg" alt="Layers Inc." size="xs" />} initials="OR" />
      <Avatar size="sm" badge={<AvatarCompanyIcon src="https://www.untitledui.com/logos/images/Layers.jpg" alt="Layers Inc." size="sm" />} initials="OR" />
      <Avatar size="md" badge={<AvatarCompanyIcon src="https://www.untitledui.com/logos/images/Layers.jpg" alt="Layers Inc." size="md" />} initials="OR" />
      <Avatar size="lg" badge={<AvatarCompanyIcon src="https://www.untitledui.com/logos/images/Layers.jpg" alt="Layers Inc." size="lg" />} initials="OR" />
      <Avatar size="xl" badge={<AvatarCompanyIcon src="https://www.untitledui.com/logos/images/Layers.jpg" alt="Layers Inc." size="xl" />} initials="OR" />
      <Avatar size="2xl" badge={<AvatarCompanyIcon src="https://www.untitledui.com/logos/images/Layers.jpg" alt="Layers Inc." size="2xl" />} initials="OR" />
    </div>
  </div>
);
