...
export const DisabledDemo = () => {
  return <Input isRequired isDisabled label="Email" hint="This is a hint text to help user." placeholder="olivia@untitledui.com" tooltip="This is a tooltip" />;
};
...
export const SizesDemo = () => {
  return (
    <div className="flex flex-col gap-8">
      ...
      {/* Medium */}
      <Input isRequired size="md" label="Email" hint="This is a hint text to help user." placeholder="olivia@untitledui.com" tooltip="This is a tooltip" />
    </div>
  );
};
...
export const LeadingIconDemo = () => {
  return (
    <Input isRequired icon={Mail01} label="Email" hint="This is a hint text to help user." placeholder="olivia@untitledui.com" tooltip="This is a tooltip" />
  );
};
    ...
    <div className="flex flex-col gap-8">
      ...
      <div className="flex flex-col gap-4">
        ...
        <Input
          ...
          tooltip="This is a tooltip"
        />
        <Input isRequired size="md" isInvalid label="Email" hint="This is an error message." placeholder="olivia@untitledui.com" tooltip="This is a tooltip" />
      </div>
    </div>
  );
};
    ...
    <div className="flex flex-col gap-8">
      <div className="flex flex-col gap-4">
        <InputGroup
          ...
          trailingAddon={
            <Button color="secondary" iconLeading={copied === "input-1" ? Check : Copy01} onClick={() => copy(inputValue1 || "www.untitledui.com", "input-1")}>
              Copy
            </Button>
          }
        >
        ...
        <InputGroup
          ...
          trailingAddon={
            <Button color="secondary" iconLeading={copied === "input-2" ? Check : Copy01} onClick={() => copy(inputValue2 || "www.untitledui.com", "input-2")}>
              Copy
            </Button>
          }
        >
        ...
        <InputGroup
          ...
          trailingAddon={
            <Button color="secondary" iconLeading={copied === "input-3" ? Check : Copy01} onClick={() => copy(inputValue3 || "www.untitledui.com", "input-3")}>
              Copy
            </Button>
          }
        >
