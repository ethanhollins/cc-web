                            ...
                            <div className="absolute top-4 right-4 z-10 flex flex-col items-end gap-2">
                                <div className="flex items-center gap-2">
                                    ...
                                    <div ref={searchContainerRef} className="relative">
                                        ...
                                        {/* Search dropdown */}
                                        {searchOpen && (
                                            <div className="absolute top-11 right-0 w-96 rounded-lg border border-gray-200 bg-white shadow-lg">
                                                {/* Search input */}
                                                    ...
                                                    {graphData && graphData.stageNodes && graphData.stageNodes.length > 0 && (
                                                        <div className="relative">
                                                            {selectedStageForSearch &&
                                                                (() => {
                                                                    const selectedNode = graphData.stageNodes.find(
                                                                        (node) => node.stage_node_id === selectedStageForSearch,
                                                                    );
                                                                    return selectedNode ? (
                                                            ...
                                                            <select
                                                                ...
                                                                className="w-full appearance-none rounded-lg border border-gray-300 bg-white py-2 pr-10 text-sm text-gray-700 shadow-sm transition outline-none hover:border-gray-400 focus:border-gray-500 focus:ring-2 focus:ring-gray-100"
                                                                ...
                                                                >
                                                                    <div className="min-w-0 flex-1">
                                                                        <div className="flex items-center gap-2">
                                                                            ...
                                                                            {ticket.ticket_type && (
                                                                                <span className="text-xs text-gray-400">{ticket.ticket_type}</span>
                                                                            )}
                                                                        </div>
                                                                        <p className="truncate text-sm text-gray-900">{ticket.title}</p>
                                                                        {ticket.ticket_status && (
                                                                            <span className="text-xs text-gray-500">{ticket.ticket_status}</span>
                                                                        )}
                                                                    </div>
                                                                    <button
